...
auto main(int argc, char** argv) -> int
{
    ...
    Order aaplMarketBuy { Order::MARKET_BUY, "AAPL", 1 };
    client.submitOrder(aaplMarketBuy);

    Order msftMarketBuy { Order::MARKET_BUY, "MSFT", 1 };
    client.submitOrder(msftMarketBuy);
