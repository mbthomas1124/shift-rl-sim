...
#from Backtesting.DB_interface import Data as dt
...
if __name__=='__main__':
    mkt = Market(start_date='2015-02-02',
                 end_date='2018-01-02',
                 cash=1000000,
                 rf = 0)
    print(mkt.cash_account, mkt.portfolio_account, mkt.market_account)
    position = pd.DataFrame([-1], index=['IBM'])
    ...
    a, b = mkt.stats.compute('monthly', isPlot=True)
    print(b)