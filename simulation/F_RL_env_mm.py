...
class SHIFT_env:
    ...
    def __init__(self,
        ...
        self.action_space= gym.spaces.Box(low = np.array([0.000005, -1, -1]), high = np.array([0.0001, 1, 1]), shape = (3,)) #gym.spaces.Box(low = np.array([1]), high = np.array([5])) #dtype=np.float32, 
