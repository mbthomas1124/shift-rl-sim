...
import time
import shift
from Two_RL_env_mm import SHIFT_env as Env
from Two_RL_env_lt import SHIFT_env as lt_env
...
def get_args(inputs):
    ...
    parser.add_argument('--hidden-sizes', type=int, nargs='*', default=[64, 64, 64]) #make larger
...
if __name__ == "__main__":
    ...
    config_dic = {
        "agents": (["mm", "mm", "mm", "mm", "lt", "lt", "lt", "lt","lt", "lt", "lt", "lt", "lt","lt",]),
                    # "mm", "mm", "mm", "mm", "lt", "lt", "lt", "lt","lt", "lt", "lt", "lt", "lt","lt"]), #    "lt", "lt", "lt", "lt","lt",
    ...
    for ticker in tickers:
        ...
        for i in range(num_proc):
            ...
            if agent_type[i] == "mm":
                ...
                print(f"marketmaker_rl_{num}")
                print(len(trader_list), len(identifiers), len(agent_type), i)
